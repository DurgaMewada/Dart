...
//  : Whenever user selects any product simulate the feature to add product in cust_cart 
//   which will contain 4 parameters for each product pro_id, pro_name, pro_qty, pro_price.
